...
const caseConferenceRouter = require("./routes/caseConferenceRoute");
...
const deliveryTypeRouter = require("./routes/deliveryTypeRoute");
...
app.use("/caseconferences", caseConferenceRouter);
...
app.use("/deliverytypes", deliveryTypeRouter);
